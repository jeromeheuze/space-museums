...
<head>
<meta charset="utf-8">
<title>SPACE Museums - Online Learning: Astronomy and Space Science</title>
<link rel="icon" type="image/png" href="http://space-museums.com/favicon.png">
<meta name="description" content="Discover our list of degrees online for learning Astronomy and Space Science.">
<meta name="abstract" content="Discover our list of degrees online for learning Astronomy and Space Science.">
...
<meta itemprop="name" content="SPACE Museums - Online Learning: Astronomy and Space Science">
<meta itemprop="description" content="Discover our list of degrees online for learning Astronomy and Space Science.">
...
<?php include("../includes/secondaryMenu.php"); ?>
    <div class="row lstsim">
    	<?php if ($simid > 0) {echo "<h1 class='htitles'><a href='/learning/'>Online Learning: Astronomy and Space Science</a></h1>";} else {echo "<h1 class='htitles'>Online Learning: Astronomy and Space Science</h1>";} ?>
        <?php include("../bin/fetch/learningPage.php"); ?>
